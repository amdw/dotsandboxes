...
of $i$ 3-chains and one $k$-chain, with $k \ge 3$, as shown in Figure
TODO.
...
\begin{table*}[p]
  ...
  \begin{tabular}{c c c c}
    $i$ & $V(P_{i,3})$ & $B$ taking optimal? & $B$ double-dealing optimal? \\
    \hline
    0 & -3 & Yes & No \\
    1 & -2 & No & Yes \\
    2 & -1 & Yes & Yes \\
...
\begin{table*}[p]
  \centering
  \begin{tabular}{c c c c}
    $i$ & $V(P_{i,4})$ & $B$ taking optimal? & $B$ double-dealing optimal? \\
    \hline
    0 & -4 & Yes & No \\
    1 & -3 & No & Yes \\
    2 & -2 & No & Yes \\
...
\begin{table*}[p]
  \centering
  \begin{tabular}{c c c c}
    $i$ & $V(P_{i,10})$ & $B$ taking optimal? & $B$ double-dealing optimal? \\
    \hline
    0 & -10 & Yes & No \\
    1 & -9 & No & Yes \\
    2 & -8 & No & Yes \\
...
for example, the position consisting of two 4-loops. In this case,
taking the first loop would mean sacrificing the second, while
double-dealing the first loop would sacrifice four coins to gain the
second loop.)
...
\begin{hardheartedbeatsloony}
  A hard-hearted handout is never worse than a half-hearted handout.
\end{hardheartedbeatsloony}
\begin{proof}
  TODO
\end{proof}
