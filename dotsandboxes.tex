...
game. In a partizan game, the options available to the two players in
a partizan game are different; for example, chess is a partizan game,
because one player controls the White pieces, and the other the
Black.) Nimstring is an impartial game, because either player can
