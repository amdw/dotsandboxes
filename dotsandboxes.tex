...
\subsection{Endgame fundamentals}
...
$k$-chain than one of the 3-chains, so we can calculate $V(P_{i,k})$
as follows.
...
\input{vc.tex}
The original repository for this project is
\texttt{https://github.com/amdw/dotsandboxes} and this version of the
paper was generated from commit \VCRevisionMod.
