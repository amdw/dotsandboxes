...
More generally, if $\mathcal{M}_P$ is a set of mutually exclusive and
jointly exhaustive sequences of moves by the same player from $P$, and
...
This definition may feel a little awkward, but it is helpful when
comparing a sequence of moves which terminates the first player's turn
with a sequence which does not.
