...
This move secures the chain through the middle square. $A$ then tries
to secure another long chain across the top, but this is easily
stopped, after which $B$'s win requires only basic endgame technique.
