...
In fact, we can prove a slightly stronger assertion, as follows.
...
\begin{itemize}
  ...
  \item All loony Nimstring positions are a win for the first player
    (similar to Theorem \ref{loonynonneg}). However in Nimstring,
    since there is no score-keeping, there are no special situations
    where you win by playing a loony move which wins more coins than
    it sacrifices.  In Nimstring, a loony move is \emph{always} a
    losing move.
