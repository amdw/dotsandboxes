...
players will strive \emph{not} to take the last coin in $P$. In this
case control of $P$ will determine the outcome of the game.
...
\begin{hardheartedbeatsloony}
  Opening a short chain or loop with a hard-hearted handout is never
  worse than making a loony move.
